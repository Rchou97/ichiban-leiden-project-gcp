...
URL = f"https://openholidaysapi.org/PublicHolidays?countryIsoCode=NL&languageIsoCode=EN&validFrom=2023-01-01&validTo={END_DATE}&subdivisionCode=NL-MI"
SOURCE = "..."


def events_to_dataframe(url: str, source: str):
    """gather public holidays data using the OpenHolidaysAPI and transform to a dataframe"""

    headers = {"accept": "application/json"}
    response = requests.get(url, headers=headers)
    public_holiday = json.loads(response.text)
